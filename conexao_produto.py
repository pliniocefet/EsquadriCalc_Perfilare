...
class ConexaoProduto:
    ...
    def insert_produto(self):
        try:
            ...
            self.sql_insert = "INSERT INTO " + self.table_name + "(codigo, descricao, linha) VALUES(%s,%s,%s)"
    ...
    def delete_produto(self, delete_value):
    ...
    def buscar_produto(self):
        self.cursor = self.connection.cursor()
        self.table_name = "produtos"
        self.sql_query = "Select codigo, descricao, linha from " + self.table_name
