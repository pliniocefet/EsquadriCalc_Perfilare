...
class Ui_tela_cadastro_vendedor(object):
    def setupUi(self, tela_cadastro_vendedor):
        ...
        tela_cadastro_vendedor.resize(668, 240)
        ...
        self.lineEdit_telefone_vendedor.setEnabled(False)
        ...
        self.lineEdit_bairro_vendedor.setEnabled(False)
        ...
        self.lineEdit_nome_vendedor.setEnabled(False)
        ...
        self.lineEdit_endereco_vendedor.setEnabled(False)
        ...
        self.lineEdit_cidade_vendedor.setEnabled(False)
        ...
        self.lineEdit_numero_vendedor.setEnabled(False)
    ...
    def retranslateUi(self, tela_cadastro_vendedor):
        ...
        self.pushButton_proximo.setText(_translate("tela_cadastro_vendedor", "Proximo"))
        self.pushButton_anterior.setText(_translate("tela_cadastro_vendedor", "Anterior"))
